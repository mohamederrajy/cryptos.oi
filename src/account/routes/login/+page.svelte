...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div>
            <img class="mx-auto h-12 w-auto" src="/images/crypto images/LOGOOC.png" alt="Logo" />
            <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
                Sign in to your account
            </h2>
        </div>
        <form class="mt-8 space-y-6" action="/account/login" method="POST" use:enhance>
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="/account/signup" class="font-medium text-primary hover:text-primary/90">
                    Sign up
                </a>
            </p>
        </div>
