...
<div class="flex flex-col lg:flex-row min-h-screen max-h-screen overflow-hidden">
    ...
    <div class="w-full lg:w-1/2 bg-gradient-to-br from-[#3772FF] to-[#2952cc] p-4 lg:p-8 flex flex-col relative overflow-y-auto lg:overflow-hidden">
        ...
        <div class="flex-grow flex flex-col justify-center relative z-10">
            <!-- Stats Section - Adjust for mobile -->
            <div class="flex gap-3 lg:gap-6 mb-6 lg:mb-12">
                <div class="bg-white/10 backdrop-blur-lg rounded-xl p-3 lg:p-4 flex-1">
                    <div class="text-white/60 text-xs lg:text-sm mb-1">Active Users</div>
                    <div class="text-white text-lg lg:text-2xl font-bold">250K+</div>
                </div>
                <div class="bg-white/10 backdrop-blur-lg rounded-xl p-3 lg:p-4 flex-1">
                    <div class="text-white/60 text-xs lg:text-sm mb-1">Daily Volume</div>
                    <div class="text-white text-lg lg:text-2xl font-bold">$2.5M</div>
                </div>
            </div>

            <!-- Main Content - Adjust text sizes for mobile -->
            <div class="space-y-4 lg:space-y-6 max-w-lg">
                <div class="space-y-2 lg:space-y-4">
                    <h1 class="text-2xl lg:text-5xl text-white font-bold leading-tight">
                        Welcome to the Future of Trading
                    </h1>
                    <p class="text-base lg:text-xl text-white/80 leading-relaxed">
            ...
            <!-- Floating Crypto Icons - Hide on mobile -->
            <div class="hidden lg:flex absolute bottom-12 right-8 items-center space-x-4">
    ...
    <!-- Right Section - Add mobile responsiveness -->
    <div class="w-full lg:w-1/2 p-4 lg:p-8 flex items-center bg-gray-50/50 backdrop-blur-sm">
...
<style lang="postcss">
    /* Keep existing styles and add mobile-specific styles */
